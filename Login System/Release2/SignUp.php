...
?>	
	...
	<table>
				...
				<tr>
					<td>
					<input type="password" name="password" placeholder="Password *"  required onkeypress="dismissPasswordWarning()"/><span id="passwordMissing" style="color:red; visibility:hidden"></span><br>
					</td>
				</tr>
				<tr>
					<td>
					<input type="password" name="confirm_password" placeholder="Confirm your Password *" required onkeypress="dismissPasswordConfirmWarning()"/><span id="passwordConfirmMissing" style="color:red; visibility:hidden">Please confirm your password.</span><br>
					</td>
				</tr>
			...
			<table> 
				...
				<tr>
					...
					<td>
					<input type="text" name="fname" placeholder="Steve" required onkeypress="dismissfnameWarning()"/><span id="firstnameMissing" style="color:red; visibility:hidden">first name is a required field.</span><br>
					</td>
				</tr>
				<tr>
					...
					<td>
					<input type="text" name="surname" placeholder="Jobs" required onkeypress="dismissSurnameWarning()"/><span id="surnameMissing" style="color:red; visibility:hidden">Surname is a required field.</span><br>
					</td>
				</tr>
				<tr>
					<td>
				...
				<td>
					...
					<td>
					<input type="email" name="email" placeholder="e.g. Myemail@email.com" required  onkeypress="dismissEmailWarning()"/><span id="invalidEmail" style="color:red; visibility:hidden">Email address missing or invalid.</span>><br>
					</td>
			</tr>
			<tr>
				...
				<tr>
					...
					<td>
					<input type="text" name="nationality" placeholder="e.g. Australia" required>
					</td>
					</tr>
...
## query database
	...
	else if ($exists == 4) echo "<p>Password not Match</p>";
	else {
